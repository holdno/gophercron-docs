import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.419948d5.js";const p="/在线节点示例.png",q=JSON.parse('{"title":"部署","description":"","frontmatter":{},"headers":[],"relativePath":"deployment/config.md","filePath":"deployment/config.md"}'),o={name:"deployment/config.md"},e=l(`<h1 id="部署" tabindex="-1">部署 <a class="header-anchor" href="#部署" aria-label="Permalink to &quot;部署&quot;">​</a></h1><h2 id="中心服务" tabindex="-1">中心服务 <a class="header-anchor" href="#中心服务" aria-label="Permalink to &quot;中心服务&quot;">​</a></h2><h3 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h3><div class="language-toml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">log_level = </span><span style="color:#9ECBFF;">&quot;debug&quot;</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 日志级别 debug info error</span></span>
<span class="line"><span style="color:#E1E4E8;">log_file = </span><span style="color:#9ECBFF;">&quot;&quot;</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 日志输出目录，留空则默认输出到stdout，同时日志文件的切分规则就不会再生效了</span></span>
<span class="line"><span style="color:#E1E4E8;">log_age = </span><span style="color:#79B8FF;">1</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 日志文件按天切割规则，不配默认为1day</span></span>
<span class="line"><span style="color:#E1E4E8;">log_size = </span><span style="color:#79B8FF;">100</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 日志文件按大小切割规则，不配默认100M</span></span>
<span class="line"><span style="color:#E1E4E8;">log_compress = </span><span style="color:#79B8FF;">false</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 日志文件切割后旧文件是否压缩，默认false</span></span>
...
<span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">micro</span><span style="color:#E1E4E8;">.</span><span style="color:#B392F0;">region_proxy</span><span style="color:#E1E4E8;">] </span><span style="color:#6A737D;"># 解决中心间夸网络环境调用问题，夸网路环境：无法直接通过服务发现拿到endpoint的IP地址进行调用，例如物理机与k8s pod间就属于不同网络环境</span></span>
<span class="line"><span style="color:#E1E4E8;">otherregion = </span><span style="color:#9ECBFF;">&quot;other region service endpoint&quot;</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 该域名需要解析到部署在其它 region 的中心服务下</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#6A737D;"># 部署时建议替换，边缘通过签名访问中心获取jwt时使用</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># oidc协议登录，授权后转为gophercron自身的登录模式，所以当前版本oidc退出登录不会影响gophercron</span></span>
<span class="line"><span style="color:#6A737D;"># 如果无oidc需求，可以不配置</span></span>
<span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">oidc</span><span style="color:#E1E4E8;">]</span></span>
...
<span class="line"><span style="color:#24292E;">log_file = </span><span style="color:#032F62;">&quot;&quot;</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 日志输出目录，留空则默认输出到stdout，同时日志文件的切分规则就不会再生效了</span></span>
<span class="line"><span style="color:#24292E;">log_age = </span><span style="color:#005CC5;">1</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 日志文件按天切割规则，不配默认为1day</span></span>
<span class="line"><span style="color:#24292E;">log_size = </span><span style="color:#005CC5;">100</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 日志文件按大小切割规则，不配默认100M</span></span>
<span class="line"><span style="color:#24292E;">log_compress = </span><span style="color:#005CC5;">false</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 日志文件切割后旧文件是否压缩，默认false</span></span>
...
<span class="line"><span style="color:#24292E;">[</span><span style="color:#6F42C1;">micro</span><span style="color:#24292E;">.</span><span style="color:#6F42C1;">region_proxy</span><span style="color:#24292E;">] </span><span style="color:#6A737D;"># 解决中心间夸网络环境调用问题，夸网路环境：无法直接通过服务发现拿到endpoint的IP地址进行调用，例如物理机与k8s pod间就属于不同网络环境</span></span>
<span class="line"><span style="color:#24292E;">otherregion = </span><span style="color:#032F62;">&quot;other region service endpoint&quot;</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 该域名需要解析到部署在其它 region 的中心服务下</span></span>
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># etcd</span></span>
...
<span class="line"><span style="color:#6A737D;"># oidc协议登录，授权后转为gophercron自身的登录模式，所以当前版本oidc退出登录不会影响gophercron</span></span>
<span class="line"><span style="color:#6A737D;"># 如果无oidc需求，可以不配置</span></span>
<span class="line"><span style="color:#24292E;">[</span><span style="color:#6F42C1;">oidc</span><span style="color:#24292E;">]</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#E1E4E8;">[</span><span style="color:#B392F0;">micro</span><span style="color:#E1E4E8;">]</span></span>
<span class="line"><span style="color:#E1E4E8;">region = </span><span style="color:#9ECBFF;">&quot;center&quot;</span><span style="color:#E1E4E8;"> </span><span style="color:#6A737D;"># 数据中心，仅业务方标记使用，可自定义命名(v2.4.2版本起)</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#24292E;">[</span><span style="color:#6F42C1;">micro</span><span style="color:#24292E;">]</span></span>
<span class="line"><span style="color:#24292E;">region = </span><span style="color:#032F62;">&quot;center&quot;</span><span style="color:#24292E;"> </span><span style="color:#6A737D;"># 数据中心，仅业务方标记使用，可自定义命名(v2.4.2版本起)</span></span>
